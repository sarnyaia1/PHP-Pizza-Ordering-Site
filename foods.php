<?php include('partials-front/menu.php'); ?>
    ...
    <section class="food-search text-center">
        <div class="container">
            ...
            <form action="<?php echo SITEURL; ?>food-search.php" method="POST">
                <input type="search" name="search" placeholder="Az én kedvenc pizzám a..." required>
    ...
    <section class="food-menu">
        <div class="container">
            ...
            <?php 
                $sql = "SELECT * FROM tbl_food WHERE glutenfree='Igen'";
                    ...
                    while($row=mysqli_fetch_assoc($res))
                    {
                        ...
                        <div class="food-menu-box">
                            ...
                            <div class="food-menu-desc">
                                ...
                                <a href="<?php echo SITEURL; ?>order.php?food_id=<?php echo $id; ?>" class="btn btn-primary">Vásárlás</a>
                            </div>
                        </div>
